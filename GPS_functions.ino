...
void sortData() {  // Function sorts data for easier processing later
...
void  GPSserialMainPrint() {    // Prints out the main body of GPS data in easy to read format
  ...
  if (GPS.fix) {
    ...
    sortData();                                                                                                                                             // Function to repackage data into more easily digestable parcels
